...
class EnemyTile(MapTile):
    def __init__(self, x, y):
        ...
        if r < 0.50:
            ...
            self.enemy = enemies.DevilMan()
            self.alive_text = "A Devil Man Blocking your Path"
            self.dead_text = "The wings and the head fall down"
        elif r < 0.60:
            self.enemy = enemies.BigBird()
            self.alive_text = "A BigBird Defend after u attack"
            self.dead_text = "The Bird are died"
        else:
